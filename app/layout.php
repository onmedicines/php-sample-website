...
<body>
    <div id="root">
        <header class="px-4 sm:px-12 py-4 border-b-2 border-purple-600 flex justify-between items-center relative">
            ...
            <button id="toggleMenuButton" class="sm:hidden">Menu</button>
            <nav class="hidden sm:flex gap-16">
                <a class="ubuntu-normal font-semibold text-zinc-500 transition-colors duration-200 hover:text-zinc-700" href="/events">Events</a>
                <a class="ubuntu-normal font-semibold text-zinc-500 transition-colors duration-200 hover:text-zinc-700" href="/career">Career</a>
                <a class="ubuntu-normal font-semibold text-zinc-500 transition-colors duration-200 hover:text-zinc-700" href="/news">Salesforce News</a>
                <a class="ubuntu-normal font-semibold text-zinc-500 transition-colors duration-200 hover:text-zinc-700" href="/articles/latest">Articles by role</a>
            </nav>
